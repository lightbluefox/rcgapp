...
//TODO: Заполнить нормальными значениями, когда смогу
                var gender = 1
//
                var createdDate = json[i]["dateCreated"] != nil ? json[i]["dateCreated"].string!.formatedDate : "";
                var rate = "";
                ...
                vacStack.append(Vacancy(id: id!, title: title, announcement: announcement, announceImageURL: announceImageURL, fulltext: fulltext, fullTextImageURL: fullTextImageURL, createdDate: createdDate, rate: rate, gender: gender, city: city, schedule: schedule, validTillDate: validTillDate));
            }
        }
